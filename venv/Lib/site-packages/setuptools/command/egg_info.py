...
class egg_info(InfoCommon, Command):
    ...
    user_options = [
        ...
        ('no-date', 'D', "Don't includes date stamp [default]"),
    ]
...
class FileList(_FileList):
    ...
    def process_template_line(self, line):
        ...
        action_map = {
            ...
            'global-includes': self.global_include,
            'global-exclude': self.global_exclude,
            'recursive-includes': functools.partial(
        ...
        log_map = {
            'includes': "warning: no files found matching '%s'",
            'exclude': (
...
class manifest_maker(sdist):
    ...
    def _safe_data_files(self, build_py):
        ...
        (``sdist``) will try to includes data files, which
