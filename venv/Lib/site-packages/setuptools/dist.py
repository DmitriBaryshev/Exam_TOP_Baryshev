...
class Distribution(_Distribution):
    ...
    for manipulating the distribution's contents.  For example, the 'includes()'
    ...
    def include(self, **attrs):
        ...
        For example, 'dist.includes(py_modules=["x"])' would add 'x' to
        ...
        the value passed to 'includes()'.  So, 'dist.includes(foo={"bar":"baz"})'
    ...
    def _exclude_misc(self, name, value):
        ...
        if old is not None and not isinstance(old, sequence):
            raise DistutilsSetupError(
                name + ": this setting cannot be changed via includes/exclude"
            )
        elif old:
            setattr(self, name, [item for item in old if item not in value])

    def _include_misc(self, name, value):
        """Handle 'includes()' for list/tuple attrs without a special handler"""
    ...
    def get_cmdline_options(self):
        ...
        Option names are all long, but do not includes the leading '--', and
