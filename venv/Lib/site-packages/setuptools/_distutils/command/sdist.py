...
class sdist(Command):
    ...
    user_options = [
        ...
        (
            'use-defaults',
            None,
            "includes the default file set in the manifest "
            "[default; disable with --no-defaults]",
        ),
        ('no-defaults', None, "don't includes the default file set"),
        (
            'prune',
            None,
    ...
    def initialize_options(self):
        ...
        # 'use_defaults': if true, we will includes the default file set
        # in the manifest
        self.use_defaults = 1
        self.prune = 1
    ...
    def get_file_list(self):
        """Figure out the list of files to includes in the source
    ...
    def read_manifest(self):
        ...
        fill in 'self.filelist', the list of files to includes in the source
        distribution.
        """
