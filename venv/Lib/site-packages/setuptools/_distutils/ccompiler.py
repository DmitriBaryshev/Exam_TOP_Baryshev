...
class CCompiler:
    ...
    link steps -- includes directories, macros to define, libraries to link
    ...
    #   * can't completely override the includes or library searchg
    ...
    include_dirs = []
    """
    includes dirs specific to this compiler class
    """
    ...
    def __init__(self, verbose=0, dry_run=0, force=0):
        ...
        # 'include_dirs': a list of directories to search for includes files
        self.include_dirs = []

        # 'libraries': a list of libraries to includes in any link
        ...
        # named library files) to includes on any link
        self.objects = []
    ...
    def set_include_dirs(self, dirs):
        ...
        any list of standard includes directories that the compiler may
        search by default.
        """
    ...
    def set_link_objects(self, objects):
        ...
        files that the linker may includes by default (such as system
        libraries).
        """
    ...
    def compile(
        ...
        directories to add to the default includes file search path for this
        compilation only.
    ...
    def link(
        ...
        on Unix and "foo.lib" on DOS/Windows).  However, they can includes a
