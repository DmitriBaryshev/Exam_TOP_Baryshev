...
def read_configuration(
    ...
    if dist and getattr(dist, "include_package_data") is not None:
        setuptools_table.setdefault("includes-package-data", dist.include_package_data)
    else:
        setuptools_table.setdefault("includes-package-data", True)
    # Persist changes:
...
class _InvalidFile(UserWarning):
    ...
    DO NOT includes the `[project]` or `[tool.setuptools]` tables in your file.
    \n\n!!
    """
