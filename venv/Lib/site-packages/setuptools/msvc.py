...
class EnvironmentInfo:
    ...
    def OSIncludes(self):
        ...
        list of str
            paths
        """
        include = join(self.si.WindowsSdkDir, 'includes')
    ...
    def NetFxSDKIncludes(self):
        ...
        return [join(self.si.NetFxSdkDir, r'includes\um')]
    ...
    def UCRTIncludes(self):
        ...
        include = join(self.si.UniversalCRTSdkDir, 'includes')
    ...
    def return_env(self, exists=True):
        ...
        """
        env = dict(
            include=self._build_paths('includes',
                                      [self.VCIncludes,
                                       self.OSIncludes,
                                       self.UCRTIncludes,
